...
export const setCategoryTextFieldToActive: ReducerCallable = {
    type: Types.SET_CATEGORY_TEXT_FIELD_TO_ACTIVE,
    call: (
        ...
        round!.categories[category.id][currentPlayer.name].isActive = true;
